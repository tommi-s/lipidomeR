...
DiagrammeR::grViz(
  diagram =
    "digraph flowchart {
      ...
      # Nodes
      node [fontname = Helvetica, shape = circle, penwidth = 5]        
      tab1 [label = '@@1']
      ...
      tab3 -> tab4 [penwidth=5];
      tab2 -> tab4 [penwidth=5];
      tab3 -> tab5;
      tab5 -> tab4;
      tab5 -> tab6;
      tab6 -> tab4;
      ...
      [7]: 'heatmap_lipidome()'
      [8]: 'lipidomeR Heatmap\\non model statistics'
      [9]: 'lipidomeR Heatmap\\non original set of observations'
      "
  )
